...
public class MainActivity extends AppCompatActivity {
    ...
    private String getListData() {
        String jsonStr = "{ \"users\" :[" +
                "{\"name\":\"Shreyas\",\"designation\":\"Asst. Prof\",\"location\":\"Anand\"}" +
                ",{\"name\":\"Rudra\",\"designation\":\"Asst. Prof\",\"location\":\"Mehsana\"}" +
                ",{\"name\":\"Kishan\",\"designation\":\"Asso. Prof\",\"location\":\"Bharuch\"}" +
                ",{\"name\":\"Jayesh\",\"designation\":\"Asso. Prof\",\"location\":\"Ahmedabad\"}] }";
        return jsonStr;
    }
}
